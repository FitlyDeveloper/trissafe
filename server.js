      ...
      messages: [
        ...
        },
        {
          ...
          content: [
            {
              type: 'text',
              text: "RETURN ONLY RAW JSON. Analyze this food image with the MOST ACCURATE values possible based on the typical nutritional composition of the identified ingredients. Use PRECISE CALORIE COUNTS - do not round to multiples of 10 or 50 (e.g., if a food has 283 calories, return 283, not 280 or 300). IMPORTANT: Each ingredient name MUST BE 14 CHARACTERS OR LESS - split longer names into separate ingredients with their own weights and calories. Ensure all nutritional values are realistic for the type of food shown.\n\n{\n  \"meal_name\": string (single name for entire meal),\n  \"ingredients\": array of strings with weights and calories (EACH INGREDIENT NAME ≤ 14 CHARS),\n  \"calories\": precise calorie count (exact number, not rounded),\n  \"protein\": realistic protein amount in grams based on ingredients,\n  \"fat\": realistic fat amount in grams based on ingredients,\n  \"carbs\": realistic carb amount in grams based on ingredients,\n  \"vitamin_c\": realistic vitamin C amount in mg based on ingredients,\n  \"health_score\": string\n}"
            },
            {
              type: 'image_url',
              image_url: { url: image }
